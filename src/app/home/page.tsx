  ...
  <Navbar />
      ...
      <section className="w-full flex justify-center bg-white py-10 md:py-14">
        <div className="w-full max-w-5xl flex flex-col md:flex-row items-center gap-8 px-4">
          <div className="flex-1 flex flex-col items-start justify-center">
            <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mb-3">Simplify Your Motor Claim Process</h1>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="#features" className="px-5 py-2 rounded font-semibold text-sm border border-gray-300 text-gray-900 hover:bg-gray-50 transition">Explore Features</a>
            </div>
          </div>
          <div className="flex-1 flex items-center justify-center">
            <div className="relative">
              <div className="absolute -inset-6 rounded-2xl blur-2xl opacity-40 hero-glow" />
              <img src="/cardemo.png" alt="Car Demo" className="relative w-96 h-64 object-cover rounded-lg shadow" />
            </div>
          </div>
        </div>
        </section>
      ...
      <section className="w-full py-12 px-4 flex flex-col items-center bg-[#f5f6f7]">
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl border p-6 flex flex-col items-center text-center transition hover:shadow-md hover:-translate-y-0.5">
      ...
      <section id="features" className="w-full py-16 px-4 flex flex-col items-center">
        ...
        <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="bg-white rounded-xl border p-6 flex flex-col items-start text-left transition hover:shadow-md hover:-translate-y-0.5">
      ...
      <section className="w-full px-4 py-12">
        <div className="w-full max-w-5xl mx-auto bg-black text-white rounded-xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <h3 className="text-xl md:text-2xl font-bold mb-1">Ready to file your claim?</h3>
            <p className="text-gray-300 text-sm">Start a new claim in minutes with guided steps and smart checks.</p>
          </div>
          <button
            onClick={() => router.push('/upload')}
            className="bg-white text-black px-5 py-2 rounded font-semibold text-sm hover:bg-gray-100 transition cursor-pointer"
          >
            Start New Claim
          </button>
        </div>
